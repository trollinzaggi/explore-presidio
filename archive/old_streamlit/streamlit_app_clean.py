...
Clean version - no sidebar, no icons, white background
"""
...
def main():
    ...
    with st.expander("View Anonymization Details"):
        ...
        with col1:
            ...
            **What Gets Removed:**
            - All bias words (gender, race, age, religion, etc.)
            - Email addresses
            - Phone numbers
            - Social media links
                    ...
                    if st.button("Show Changes", use_container_width=True):
                        with st.expander("What Changed", expanded=True):
                            ...
                            with col1:
                                st.markdown("""
                                **Experience Section:**
                                - Removed bias from job titles
                                - Removed bias from descriptions
                                - Company names → 'removed'
                                
                                **Education/Qualification:**
                                - Institution names → 'removed'
                                - Removed bias from achievements
                                - Kept degrees and years
                                """)
                            
                            with col2:
                                st.markdown("""
                                **Affiliation Changes:**
                                - Organization names → 'removed'
                                - Removed bias from positions
                                - Removed bias from award names
                                - Removed bias from descriptions
                                - Removed bias from membership roles
                                """)
    else:
