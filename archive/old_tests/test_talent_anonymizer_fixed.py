...
Run from: /Users/bijoykarnani/VS Code/explore-presidio/bias-anonymizer/
"""
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"\nImport Error: {e}")
        print("\nMake sure you have copied the updated files:")
        print("1. src/bias_anonymizer/talent_profile_anonymizer.py")
        print("2. src/bias_anonymizer/bias_recognizers.py")
        print("\nAnd that you're running from: /Users/bijoykarnani/VS Code/explore-presidio/bias-anonymizer/")
